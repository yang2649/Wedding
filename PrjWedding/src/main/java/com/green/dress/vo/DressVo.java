...
public class DressVo {
	...
	public DressVo() {}
	public DressVo(String favid, String dressid, String dressname, String dressfor, int dressprice, String dressimage,
			String memid) {
	...
	public String toString() {
		return "DressVo [favid=" + favid + ", dressid=" + dressid + ", dressname=" + dressname + ", dressfor=" + dressfor
