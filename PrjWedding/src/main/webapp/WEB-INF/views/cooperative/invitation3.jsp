...
<br><br><br><br>
	...
	<h1 style="text-align: center;">
			<span style="color: rgb(191, 131, 101);" ">BNIEL497</span></h1>
	</div> <br><br>
	<div style="text-align: center;"">
	<img src="./img/invitation/b497.jpg" />
	</div><br><br>
	<div id="buffet-text"><br><br>
		<div id="ddd">
		<h2>
	  	<video muted autoplay loop style="width: 80%; text-align: center;">
	      <source src="./img/invitation/b497.mp4" type="video/mp4">
	    </video>
	    </h2>
	    </div>
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center;">
      ...
      <img
           src="./img/invitation/b497_01.jpg"
           alt="swamp"
           />
      <img
           src="./img/invitation/b497_02.jpg"
           alt="swamp"
           />
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; ">
      ...
      <img
           src="./img/invitation/b497_03.jpg"
           alt="swamp"
           />
      <img
           src="./img/invitation/b497_04.jpg"
           alt="swamp"
           />
