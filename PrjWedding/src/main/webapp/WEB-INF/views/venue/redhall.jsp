...
<br><br><br><br>
	...
	<!-- 슬라이드 -->
	 <div class="slideshow-container">
      ...
      <div class="mySlides">
        ...
        <img src="./img/hall/bhall01.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>

      <div class="mySlides">
        <div class="numbertext">2 / 5</div>
        <img src="./img/hall/bhall02.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>

      <div class="mySlides">
        <div class="numbertext">3 / 5</div>
        <img src="./img/hall/bhall03.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>

      <div class="mySlides">
        <div class="numbertext">4 / 5</div>
        <img src="./img/hall/bhall04.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>

      <div class="mySlides">
        <div class="numbertext">5 / 5</div>
        <img src="./img/hall/bhall05.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding: 1vw;">
      ...
      <img
           src="./img/bride/bbride01.jpg"
           alt="swamp"
           />
      <img
           src="./img/bride/bbride02.jpg"
           alt="swamp"
           />
      <img
           src="./img/bride/bbride03.jpg"
           alt="swamp"
           />
    </div>
  </div>
