	...
	<!-- 슬라이드 -->
	 <div class="slideshow-container">
      ...
      <div class="mySlides">
        ...
        <img src="./img/hall/ahall01.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>

      <div class="mySlides">
        <div class="numbertext">2 / 5</div>
        <img src="./img/hall/ahall02.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>

      <div class="mySlides">
        <div class="numbertext">3 / 5</div>
        <img src="./img/hall/ahall03.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>

      <div class="mySlides">
        <div class="numbertext">4 / 5</div>
        <img src="./img/hall/ahall04.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>

      <div class="mySlides">
        <div class="numbertext">5 / 5</div>
        <img src="./img/hall/ahall05.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>
