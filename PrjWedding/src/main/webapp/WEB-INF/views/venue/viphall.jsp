...
<br><br><br><br>
	<div id="text-table">
	 ...
	 <div class="slideshow-container">
      ...
      <div class="mySlides">
        ...
        <img src="./img/hall/viphall01.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>

      <div class="mySlides">
        <div class="numbertext">2 / 3</div>
        <img src="./img/hall/viphall02.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>

      <div class="mySlides">
        <div class="numbertext">3 / 3</div>
        <img src="./img/hall/viphall03.jpg" style="width:100%">
        <div class="text">GREEM WEDDING</div>
      </div>
    ...
    <div style="display: flex; flex-wrap: wrap; justify-content: center; padding: 1vw;">
      ...
      <img
           src="./img/bride/ebride01.jpg"
           alt="swamp"
           />
      <img
           src="./img/bride/ebride02.jpg"
           alt="swamp"
           />
      <img
           src="./img/bride/ebride03.jpg"
           alt="swamp"
           />
    </div>
  </div>
